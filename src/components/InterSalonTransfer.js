  ...
  return (
    ...
    >
      ...
      <DialogContent>
        ...
        <Card sx={{ 
          mb: 3, 
          bgcolor: getGenderColor(student) === 'secondary' ? alpha(theme.palette.secondary.main, 0.08) : alpha(theme.palette.primary.main, 0.08),
          border: `2px solid ${getGenderColor(student) === 'secondary' ? theme.palette.secondary.main : theme.palette.primary.main}`
        }}>
          <CardContent>
        ...
        {selectedTargetSalon && (
          <Paper sx={{ 
            mt: 3, 
            p: 2, 
            bgcolor: getGenderColor(student) === 'secondary' ? alpha(theme.palette.secondary.main, 0.06) : alpha(theme.palette.primary.main, 0.06),
            border: `2px solid ${getGenderColor(student) === 'secondary' ? theme.palette.secondary.main : theme.palette.primary.main}`
          }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <ArrowIcon sx={{ 
                color: getGenderColor(student) === 'secondary' ? 'secondary.main' : 'primary.main'
              }} />
              <Typography sx={{
                color: getGenderColor(student) === 'secondary' ? 'secondary.dark' : 'primary.dark'
              }}>
