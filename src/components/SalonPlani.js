      ...
      <Paper elevation={1} sx={{ p: { xs: 1, sm: 2 }, maxWidth: { xs: '100%', sm: 1400 }, mx: 'auto' }}>
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Typography variant="h6" component="h2" sx={{ fontSize: { xs: '1rem', sm: '1.25rem' }, color: 'text.primary', fontWeight: 700 }}>
            ...
            {seciliOgrenci ? (
              <Box>
                <Box sx={{
                  ...
                  <Typography variant="h5" sx={{ fontWeight: 700, color: `${getGenderColor(seciliOgrenci)}.main` }}>
